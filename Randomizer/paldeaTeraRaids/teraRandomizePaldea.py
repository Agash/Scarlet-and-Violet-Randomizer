...
def randomizePaldea(config, pokemonAllowed, legendsAllowed):
    if pokemonAllowed is None:
        pokemonAllowed = [i for i in range(0, 1026)]
    for i in range(1, 7):
        ...
        randomizeRaids(paldeaRaids, pokemonAllowed)

        if generationLimter is False:
            if config['only_paradox'] == "yes":
                paldeaRaids = randomizeRaids(paldeaRaids, paradox)
            if config['only_legends'] == "yes":
                paldeaRaids = randomizeRaids(paldeaRaids, legends)
            if config['only_legends_and_paradox'] == "yes":
                paldeaRaids = randomizeRaids(paldeaRaids, legends_and_paradox)
        else:
            if config['only_paradox'] == "yes" and in_array[8] == 1:
                paldeaRaids = randomizeRaids(paldeaRaids, paradox)
            if config['only_legends'] == "yes":
                paldeaRaids = randomizeRaids(paldeaRaids, legendsAllowed)
